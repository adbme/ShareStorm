...
<header>
  <div class="dropdown" id="dropdown">
    <button class="btn btn-transparent" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
      aria-expanded="false" style="background-color: #23272B">
...
<div class="container-test">
  <div class="row">
    <div class="col-12 sr">
      <div class="d-flex align-items-center mb-3">
        ...
        <h1 class="mb-0"
          style="margin-left: 30px; font-size: 50px; color: white; display: flex; align-items: center; height: 130px;">
          <div class="gs-div">
            <p class="gs">></p>
          </div> Getting Started
        </h1>
  ...
  <div class="row">
    ...
    <?php require "pages/tools/raccourcis.php" ?>
